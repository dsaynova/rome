...
python -m pararel.fact_recall_detection.causal_trace \
    --model_name "gpt2-xl" \
    --fact_file "/cephyr/users/lovhag/Alvis/projects/rome/data/confident_fact_recall_detection/gpt2_xl_preds.jsonl" \
    --output_dir "/cephyr/users/lovhag/Alvis/projects/rome/data/confident_fact_recall_detection/gpt2_xl_causal_trace_${SLURM_JOB_ID}" \
    --only_te \